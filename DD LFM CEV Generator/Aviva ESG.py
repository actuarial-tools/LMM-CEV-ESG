...
loc = '16. Actuarial Function\\05. Economic Scenario Générator\\00 - DD LMM CEV\\02 - Models\\Excel UI'

# Initialize Curve Setup
import CalibSetup # Very important because in this module we will modify some values in the CalibSetup module

# Extract all the functions from the CalibSetup package
from CalibSetup import *

'''TEST
==================================================================================================='''
# resultsR = chiSquareCalibratorR()
# resultsPython = chiSquareCalibratorPython()

# Calibration Test
fullResults = fullCalibrator()

fZero = 0.884537132708673
gamma = 0.445693220257848
a =  0.0226414995213956
b = 0.00418458820547696
c = 0.0557350554194948
d = 0.000001
eta = 0.8
delta = 0.1
simulations = 5000

'''SIMULATION WITH BH INPUTS
================================'''
results = fullSimulator(forwardCurve, fZero, gamma, a, b, c, d, eta, betas, delta, 
                  simulations = 5000, 
                  maxProjectionYear = 50, 
                  maxMaturity = 40,
                  viewDistributions = True,
